...
public class TEscaleno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tescaleno);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etLado1.getText().toString().isEmpty()||etLado2.getText().toString().isEmpty()||etLado3.getText().toString().isEmpty())
                {
                    ...
                    {
                        Toast error=Toast.makeText(v.getContext(),"LADOS IGUALES",Toast.LENGTH_LONG);
                        error.show();
                    }else{
                        ...
                        if(rbArea.isChecked()==true)
                        {
                            ...
                            intento.putExtra("Resultado","Area lado 1= "+Double.toString(area1)+" Metros Cuadrados, Area lado 2= "+Double.toString(area2)+" Metros Cuadrados, Area lado 3= "+Double.toString(area3));
